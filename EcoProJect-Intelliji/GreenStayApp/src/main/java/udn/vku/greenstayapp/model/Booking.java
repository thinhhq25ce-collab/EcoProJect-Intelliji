...
public class Booking {
    ...
    // Constructor 1: Dùng để hiển thị danh sách (Full thông tin)
    ...
    // --- Constructor 2: CÁI BẠN ĐANG THIẾU (Dùng để tạo mới booking) ---
    // Khớp chính xác với dòng code bị lỗi của bạn
    public Booking(int userId, int roomId, LocalDate checkIn, LocalDate checkOut, double totalPrice) {
        this.userId = userId;
        this.roomId = roomId;
        this.checkIn = checkIn;
        this.checkOut = checkOut;
        this.totalPrice = totalPrice; // Đã thêm giá tiền
        this.status = "PENDING";      // Mặc định trạng thái chờ
