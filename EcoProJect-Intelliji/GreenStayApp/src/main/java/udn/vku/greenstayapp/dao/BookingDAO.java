...
public class BookingDAO {
    ...
    // 1. Lưu đơn đặt phòng (Lưu cả tổng tiền)
    public boolean createBooking(Booking b) {
        String sql = "INSERT INTO booking (user_id, room_id, check_in, check_out, total_price, status, created_at) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    // 2. Lấy danh sách Booking (Luôn lấy mới nhất từ DB)
    ...
    // 3. Tính tổng doanh thu theo tháng (Real-time)
